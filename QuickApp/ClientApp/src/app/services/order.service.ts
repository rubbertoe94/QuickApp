...
export class OrderService {
  ...
  getOrders(pageNumber: number, pageSize: number, searchTerm: string): Observable<any[]> {
    return this.orderEndpoint.getOrdersEndpoint(pageNumber, pageSize, searchTerm);
  }
