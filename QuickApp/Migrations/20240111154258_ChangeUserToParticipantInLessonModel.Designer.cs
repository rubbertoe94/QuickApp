...
namespace QuickApp.Migrations
{
    ...
    [Migration("20240111154258_ChangeUserToParticipantInLessonModel")]
    partial class ChangeUserToParticipantInLessonModel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAL.Models.Court", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DAL.Models.Lesson", b =>
                {
                    b.HasOne("DAL.Models.User", "Coach")
                        .WithMany()
                        .HasForeignKey("CoachId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DAL.Models.Court", "Court")
                        .WithMany()
                    ...
                    b.HasOne("DAL.Models.User", "Participant")
                        .WithMany()
